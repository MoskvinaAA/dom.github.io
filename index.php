...
<header class="header_">
		<div class="container">
			<div class="header_inner">
				<a href="index.html"><img class="header_item_logo" src="img/logo/logo.png" alt="HTML5"></a>
...
<div class="menu-main">
	<div class="container">
		<nav class="menu">
			<ul id="top-menu">
				<li><a href="index.html" class="active-button">Главная</a></li>
				...
				<li><a class= "top_" href="reviews.html">Отзывы</a></li>
			</ul>
		</nav>
	</div>	
</div>
